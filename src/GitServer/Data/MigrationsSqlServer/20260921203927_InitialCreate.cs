        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Pattern = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false, collation: "SQL_Latin1_General_CP1_CI_AS"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowUserRepoCreation = table.Column<bool>(type: "bit", nullable: false),
                    AllowPushToCreateRepositories = table.Column<bool>(type: "bit", nullable: false),
                    AllowAnonymousPush = table.Column<bool>(type: "bit", nullable: false),
                    ShowCommitAuthorAvatar = table.Column<bool>(type: "bit", nullable: false),
                    ApiKeyLifetimeDays = table.Column<int>(type: "int", nullable: false, defaultValue: 90)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepositoryAccesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepositoryAccesses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RepositoryAccesses_Repositories_RepositoryId",
                        column: x => x.RepositoryId,
                        principalTable: "Repositories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepositoryAccesses_UserId",
                table: "RepositoryAccesses",
                column: "UserId");
            ...
            // Editable defaults, the same two the SQLite migration seeds; the built-in names (api, dashboard, ...) live in code.
